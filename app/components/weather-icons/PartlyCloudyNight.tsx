...
interface PartlyCloudyNightProps extends React.SVGProps<SVGSVGElement> {
  /** 是否启用动画 */
  animate?: boolean;
}

export default function PartlyCloudyNight({ animate = true, className, style, ...props }: PartlyCloudyNightProps) {
