...
interface ThunderstormsDayProps extends React.SVGProps<SVGSVGElement> {
  /** 是否启用动画 */
  animate?: boolean;
}

export default function ThunderstormsDay({ animate = true, className, style, ...props }: ThunderstormsDayProps) {
