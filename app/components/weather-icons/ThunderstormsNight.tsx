...
interface ThunderstormsNightProps extends React.SVGProps<SVGSVGElement> {
  /** 是否启用动画 */
  animate?: boolean;
}

export default function ThunderstormsNight({ animate = true, className, style, ...props }: ThunderstormsNightProps) {
