...
interface OvercastDayProps extends React.SVGProps<SVGSVGElement> {
  /** 是否启用动画 */
  animate?: boolean;
}

export default function OvercastDay({ animate = true, className, style, ...props }: OvercastDayProps) {
